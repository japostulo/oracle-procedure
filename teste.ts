...
import { ListarDadosAtendimento } from "src/listar-dados-atendimento";
...
async function connect() {
    ...
    try {
        ...
        const procedure = new ListarDadosAtendimento(oracleConnection)

        // procedure.cd_pessoa_fisica = '1303467'

        const data = await procedure.execute()
